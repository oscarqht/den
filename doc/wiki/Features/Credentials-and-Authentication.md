...
- Stores credential metadata in local JSON and secrets in OS keychain via `keytar`.
...
- Git credentials metadata: `~/.viba/credentials.json`.
- Agent API metadata: `~/.viba/agent-api-configs.json`.
