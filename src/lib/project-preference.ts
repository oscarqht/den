...
type ProjectPreferenceFields = Pick<Project, 'id' | 'iconPath' | 'lastOpenedAt'>;
...
function hasProjectIcon(project: Pick<Project, 'iconPath'>): boolean {
  return Boolean(project.iconPath?.trim());
}
